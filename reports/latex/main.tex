...
\begin{spacing}{1.5}
    \input{contenido/1-introduccion}
    \input{contenido/2-dataset}
    \input{contenido/3-preparacion}
    \input{contenido/4-eda}
    \input{contenido/5-modelo}
    \input{contenido/6-clustering}
    \input{contenido/7-arquitectura}
    \input{contenido/8-reutilizacion}
